...
def convert_instance_to_dict(x, mask_format):
...
class CopyPaste:
    ...
    def __call__(self, results, logger=None, save_img_dir=None):
        ...
        results = convert_instance_to_dict(results, self.mask_format)
        if results is None :
            return results_origin
        ...
        for i in range(num_images) :
            ...
            selected_results = convert_instance_to_dict(mix_results, self.mask_format)
