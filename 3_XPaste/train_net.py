...
from xpaste.modeling.roi_heads import roi_heads
import xpaste.modeling.roi_heads.refine_mask_head
from xpaste import ModelEma
from xpaste.data.build import build_detection_train_loader, get_detection_dataset_dicts
from xpaste.evaluation.custom_lvis_eval import CustomLVISEvaluator
...
def do_train(cfg, model, resume=False, model_ema=None):
    ...
    if cfg.DATALOADER.SAMPLER_TRAIN in ['TrainingSampler', 'RepeatFactorTrainingSampler', 'WeightedTrainingSampler', 'WeightedCategoryTrainingSampler']:
    ...
    with EventStorage(start_iter) as storage:
        ...
        for data, iteration in zip(data_loader, range(start_iter, max_iter)):
            ...
            # print('data:',[d['file_name'] for d in data])
            ###########################
...
if __name__ == "__main__":
    ...
    if args.num_machines == 1:
        ...
        # args.dist_url = 'tcp://{}:{}'.format(os.environ['MASTER_ADDR'],
        #     torch.randint(11111, 60000, (1,))[0].item())
        args.dist_url = "auto"
    else:
