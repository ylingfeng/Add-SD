...
from inpaint_anything.utils.mask_processing import crop_for_filling_pre, crop_for_filling_post
from inpaint_anything.utils.crop_for_replacing import recover_size, resize_and_pad
from inpaint_anything.utils import load_img_to_array, save_array_to_img
...
def fill_img_with_sd(
    ...
    pipe = StableDiffusionInpaintPipeline.from_pretrained(
        "/root/paddlejob/workspace/env_run/output/zhangxinyu14/baidu/personal-code/pretrained/models--stabilityai--stable-diffusion-2-inpainting/snapshots/81a84f49b15956b60b4272a405ad3daef3da4590/", 
...
def replace_img_with_sd(
    ...
    pipe = StableDiffusionInpaintPipeline.from_pretrained(
        "/root/paddlejob/workspace/env_run/output/zhangxinyu14/baidu/personal-code/pretrained/models--stabilityai--stable-diffusion-2-inpainting/snapshots/81a84f49b15956b60b4272a405ad3daef3da4590/", #"stabilityai/stable-diffusion-2-inpainting",
